...
class ROBOT_GOAL():
	def __init__(self):
		...
		path_name = rospy.get_param("~path_name", "test.txt")
		self.txt_path = os.path.join(rospack.get_path('navigation'), "config", path_name)
