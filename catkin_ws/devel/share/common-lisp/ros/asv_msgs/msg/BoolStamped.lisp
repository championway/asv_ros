...
(cl:defmethod cl:initialize-instance :after ((m <BoolStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoolStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<BoolStamped> is deprecated: use asv_msgs-msg:BoolStamped instead.")))
...
(cl:defmethod data-val ((m <BoolStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:data-val is deprecated.  Use asv_msgs-msg:data instead.")
  (data m))
