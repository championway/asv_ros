...
(cl:defmethod cl:initialize-instance :after ((m <VelocityVector>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'VelocityVector)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<VelocityVector> is deprecated: use asv_msgs-msg:VelocityVector instead.")))
...
(cl:defmethod angular-val ((m <VelocityVector>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:angular-val is deprecated.  Use asv_msgs-msg:angular instead.")
  (angular m))
