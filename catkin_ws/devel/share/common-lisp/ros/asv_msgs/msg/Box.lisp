...
(cl:defmethod cl:initialize-instance :after ((m <Box>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Box)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<Box> is deprecated: use asv_msgs-msg:Box instead.")))
...
(cl:defmethod w-val ((m <Box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:w-val is deprecated.  Use asv_msgs-msg:w instead.")
  (w m))

(cl:ensure-generic-function 'h-val :lambda-list '(m))
(cl:defmethod h-val ((m <Box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:h-val is deprecated.  Use asv_msgs-msg:h instead.")
  (h m))

(cl:ensure-generic-function 'confidence-val :lambda-list '(m))
(cl:defmethod confidence-val ((m <Box>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:confidence-val is deprecated.  Use asv_msgs-msg:confidence instead.")
  (confidence m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Box>)))
  ...
  "49a6b261b655b7a5a235174ffa9e8810")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Box)))
  "Returns md5sum for a message object of type 'Box"
  "49a6b261b655b7a5a235174ffa9e8810")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Box>)))
  ...
  (cl:format cl:nil "int32 x~%int32 y~%int32 w~%int32 h~%float32 confidence~%int32 id~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Box)))
  "Returns full string definition for message of type 'Box"
  (cl:format cl:nil "int32 x~%int32 y~%int32 w~%int32 h~%float32 confidence~%int32 id~%~%"))
