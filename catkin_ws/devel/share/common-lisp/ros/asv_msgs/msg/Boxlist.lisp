...
(cl:defclass <Boxlist> (roslisp-msg-protocol:ros-message)
  ((list
    :reader list
    :initarg :list
    :type (cl:vector asv_msgs-msg:Box)
   :initform (cl:make-array 0 :element-type 'asv_msgs-msg:Box :initial-element (cl:make-instance 'asv_msgs-msg:Box)))
   (image_width
    :reader image_width
    :initarg :image_width
    :type cl:integer
...
(cl:defmethod cl:initialize-instance :after ((m <Boxlist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Boxlist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<Boxlist> is deprecated: use asv_msgs-msg:Boxlist instead.")))
...
(cl:defmethod image_width-val ((m <Boxlist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:image_width-val is deprecated.  Use asv_msgs-msg:image_width instead.")
  (image_width m))

(cl:ensure-generic-function 'image_height-val :lambda-list '(m))
(cl:defmethod image_height-val ((m <Boxlist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:image_height-val is deprecated.  Use asv_msgs-msg:image_height instead.")
  (image_height m))

(cl:ensure-generic-function 'image-val :lambda-list '(m))
(cl:defmethod image-val ((m <Boxlist>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:image-val is deprecated.  Use asv_msgs-msg:image instead.")
  (image m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Boxlist>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'list)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'asv_msgs-msg:Box))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Boxlist>)))
  ...
  (cl:format cl:nil "Box[] list~%int32 image_width~%int32 image_height~%sensor_msgs/CompressedImage image~%================================================================================~%MSG: asv_msgs/Box~%int32 x~%int32 y~%int32 w~%int32 h~%float32 confidence~%int32 id~%================================================================================~%MSG: sensor_msgs/CompressedImage~%# This message contains a compressed image~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%~%string format        # Specifies the format of the data~%                     #   Acceptable values:~%                     #     jpeg, png~%uint8[] data         # Compressed image buffer~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Boxlist)))
  "Returns full string definition for message of type 'Boxlist"
  (cl:format cl:nil "Box[] list~%int32 image_width~%int32 image_height~%sensor_msgs/CompressedImage image~%================================================================================~%MSG: asv_msgs/Box~%int32 x~%int32 y~%int32 w~%int32 h~%float32 confidence~%int32 id~%================================================================================~%MSG: sensor_msgs/CompressedImage~%# This message contains a compressed image~%~%Header header        # Header timestamp should be acquisition time of image~%                     # Header frame_id should be optical frame of camera~%                     # origin of frame should be optical center of camera~%                     # +x should point to the right in the image~%                     # +y should point down in the image~%                     # +z should point into to plane of the image~%~%string format        # Specifies the format of the data~%                     #   Acceptable values:~%                     #     jpeg, png~%uint8[] data         # Compressed image buffer~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
