...
(cl:defmethod cl:initialize-instance :after ((m <Motor4Cmd>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Motor4Cmd)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<Motor4Cmd> is deprecated: use asv_msgs-msg:Motor4Cmd instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Motor4Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:header-val is deprecated.  Use asv_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'lf-val :lambda-list '(m))
(cl:defmethod lf-val ((m <Motor4Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:lf-val is deprecated.  Use asv_msgs-msg:lf instead.")
  (lf m))

(cl:ensure-generic-function 'rf-val :lambda-list '(m))
(cl:defmethod rf-val ((m <Motor4Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:rf-val is deprecated.  Use asv_msgs-msg:rf instead.")
  (rf m))

(cl:ensure-generic-function 'lr-val :lambda-list '(m))
(cl:defmethod lr-val ((m <Motor4Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:lr-val is deprecated.  Use asv_msgs-msg:lr instead.")
  (lr m))

(cl:ensure-generic-function 'rr-val :lambda-list '(m))
(cl:defmethod rr-val ((m <Motor4Cmd>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:rr-val is deprecated.  Use asv_msgs-msg:rr instead.")
  (rr m))
