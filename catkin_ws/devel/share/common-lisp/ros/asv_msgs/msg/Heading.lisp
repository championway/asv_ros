...
(cl:defmethod cl:initialize-instance :after ((m <Heading>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Heading)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name asv_msgs-msg:<Heading> is deprecated: use asv_msgs-msg:Heading instead.")))

(cl:ensure-generic-function 'phi-val :lambda-list '(m))
(cl:defmethod phi-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:phi-val is deprecated.  Use asv_msgs-msg:phi instead.")
  (phi m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Heading>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader asv_msgs-msg:speed-val is deprecated.  Use asv_msgs-msg:speed instead.")
  (speed m))
