...
"""autogenerated by genpy from duckiepond/Box.msg. Do not edit."""
import sys
...
class Box(genpy.Message):
  _md5sum = "49a6b261b655b7a5a235174ffa9e8810"
  _type = "duckiepond/Box"
...
float32 confidence
int32 id"""
  __slots__ = ['x','y','w','h','confidence','id']
  _slot_types = ['int32','int32','int32','int32','float32','int32']
