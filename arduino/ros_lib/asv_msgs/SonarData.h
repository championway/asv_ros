#ifndef _ROS_asv_msgs_SonarData_h
#define _ROS_asv_msgs_SonarData_h
...
namespace asv_msgs
{
  ...
  class SonarData : public ros::Msg
  {
    ...
    const char * getType(){ return "asv_msgs/SonarData"; };
    const char * getMD5(){ return "80edb5d87c655c7bf9ec5dd6877934db"; };
